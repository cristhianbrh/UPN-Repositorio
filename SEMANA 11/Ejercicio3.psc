Proceso sin_titulo
	// Dise�e un algoritmo para indicar el nivel de logro de un estudiante en base a su calificativo
	...
	Escribir "Introduce la calificaci�n del estudiante"; Leer user_calif;
	//Cristhian B.R
	Si user_calif <= 20 y user_calif >= 0 Entonces
		...
		Escribir "Tu nivel de logro seg�n tu calificaci�n es: ", estado, ".";
	SiNo
		Escribir  "Has introducido un n�mero inv�lido";
	FinSi
